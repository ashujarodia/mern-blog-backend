...
import { addComment, deleteBlog, deleteComment, getAllBlogs, getMyBlogs, getUserBlogs, likeBlog, newBlog, updateBlog } from '../controllers/blog.js';
...
router.get('/getUserBlogs/:id', isAuthenticated, getUserBlogs);
